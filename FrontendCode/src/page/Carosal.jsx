  ...
  return (
    <div className="background">
      ...
      <article className="card">
        <figure>
          <img src="CourseImg/istockphoto-529418492-612x612.jpg" alt="" title="">
          </img>
        </figure>
      ...
      <article className="card">
        <figure>
          <img src="CourseImg/istockphoto-658859022-612x612.jpg" alt="" title="">
          </img>
        </figure>
        <div className="course-details">
      ...
      <article className="card">
        <figure>
          <img src="CourseImg/istockphoto-1257617279-612x612.jpg" alt="" title="">
          </img>
        </figure>
        <div className="course-details">
      ...
      <article className="card">
        <figure>
          <img src="CourseImg/istockphoto-1311084713-612x612.jpg" alt="" title="">
          </img>
        </figure>
        <div className="course-details">
        <p>
      ...
      <article className="card">
        <figure>
          <img src="CourseImg/istockphoto-1407200725-612x612.jpg" alt="" title="">
          </img>
        </figure>
        <div className="course-details">
      ...
      <article className="card">
        <figure>
          <img src="CourseImg/istockphoto-1399154821-170667a.webp" alt="" title="">
          </img>
        </figure>
        <div className="course-details">
      ...
      <article className="card">
        <figure>
          <img src="CourseImg/istockphoto-1396520400-612x612.jpg" alt="" title="">
          </img>
        </figure>
        <div className="course-details">
        ...
        <figure>
          <img src="CourseImg/istockphoto-1393947553-170667a.webp" alt="" title="">
          </img>
        </figure>
        <div className="course-details">
